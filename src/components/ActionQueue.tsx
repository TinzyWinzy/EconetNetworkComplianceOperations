      ...
      {queue.length === 0 ? (
        ...
        <ol className="mt-2 divide-y divide-slate-100">
          {queue.map(({ t }, idx) => {
            ...
            return (
              <li key={t.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 py-3 border-b border-slate-100 last:border-0">
                <div className="min-w-0">
                  ...
                  <p className="tnum text-xs text-slate-500 mt-0.5">
                    ...
                    <span className="block sm:inline sm:ml-1 font-semibold text-blue-800">· Crew ETA ~45m</span>
                  </p>
                </div>
                <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
                  <span className="tnum rounded bg-red-50 px-2 py-1 text-xs font-bold text-red-800 shrink-0">
                  ...
                  {readOnly ? (
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <select
                        ...
                        className="min-h-[38px] sm:min-h-[44px] rounded-lg border border-slate-300 px-2 py-1.5 text-xs bg-white"
                      ...
                      <button
                        ...
                        className="min-h-[38px] sm:min-h-[44px] rounded-lg bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white hover:bg-slate-800 active:scale-95 transition-all"
                      >
                        Assign
                      </button>
                    </div>
